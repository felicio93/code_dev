    ...
    for date in dates:
        ...
        try:
            ...
            ds1 = xr.open_dataset(
                ...
                chunks={},
                engine='h5netcdf',
                drop_variables=['vvel4.5','uvel4.5','vvel_bottom','uvel_bottom','vvel_surface','uvel_surface','salt_bottom','temp_bottom','depth']
            )
...
def main(var,start_date,end_date,averaged,output_dir,timestep):
    ...
    if averaged==False:
        for n,z in enumerate(ds):
            if n>0 and timestep>0:
                n=(n*timestep)-1
            print(n)
            #z = np.array(ds.variables[var][n])
            time_str=times[n]
            if var == 'temp_surface':
                plot_stofs_pac_T(triangulation,
                            z,
            ...
            if var == 'salt_surface':
                plot_stofs_pac_S(triangulation,
                            z,
                            output_dir=output_dir,
                            n=n,
                            long_name=long_name,
            ...
            if var == 'elev':
                plot_stofs_pac_H(triangulation,
                            z,
                            output_dir=output_dir,
                            n=n,
                            long_name=long_name,
...
if __name__ == '__main__':
    ...
    var = 'elev'#'salt_surface'#'temp_surface'
    start_date='20240801'
    end_date='20240901'
    averaged=False #if true it calculates the climatology, if false it will be one file per timestep
    output_dir=r"C:\Users\Felicio.Cassalho\Work\Modeling\AK_Project\STOFS_postprocessing\figures\2024_08_ssh/"
    #output_dir=r"/work2/noaa/nosofs/felicioc/work/stofs_pac/figures/sst_2024_08/"
    timestep=6 #every X hours

    main(var,start_date,end_date,averaged,output_dir,timestep)
